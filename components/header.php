<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="offcanvas__logo">
            <a href="index.php"><img src="/upload/logo/logo-phuclong.png" alt="Phúc Long" style="max-width: 140px; height: auto; object-fit: contain;"></a>
        </div>
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-2">
                    <div class="header__logo">
                        <a href="index.php"><img style="max-height: 45px; object-fit: contain;" src="/upload/logo/logo-phuclong.png" alt="Phúc Long"></a>
                    </div>
                </div>
